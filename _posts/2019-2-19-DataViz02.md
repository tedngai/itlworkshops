...
<hr />
## Project Description
In this first workshop you will learn to do a fairly straight forward webscraping exercise to visualize the income level of the CUNY Faculty. By the end of this session, you will learn to do something like this.
