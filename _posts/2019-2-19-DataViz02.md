...
<iframe width="640" height="500" frameborder="0" scrolling="no" src="//plot.ly/~tngai/86.embed"></iframe>
...
For direct link:
><a href="https://www.seethroughny.net/payrolls/107209525" target="_blank" class="button">FIT Payroll</a>

For data files:
><a href="../../../assets/files/SalaryScrape.zip" class="button">Download Data File</a>
...
```<pre><code>'''cd /Users/tedngai/Desktop/dataviz```
...
><a href="https://www.w3schools.com/html/html_examples.asp" class="button special fit">Deep Dive: HTML</a>
...
<div class="6u 12u$(small)">
	<ul class="actions vertical">
		<li><a href="https://plot.ly/python/" class="button special fit">Deep Dive: Plot.ly Graphs</a></li>
	</ul>
</div>
