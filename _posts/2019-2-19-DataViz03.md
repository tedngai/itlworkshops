...
<pre><code>df_moma[['Artist','Nationality','BeginDate','Gender']] = df_moma[['Artist','Nationality','BeginDate','Gender']].fillna(value='Unknown')</code></pre>
...
Next we give the new list a label and create a new Pandas DataFrame for it. So now when you type in the following, you should see this.
...
![](../../../assets/images/pic_jupyter_CC_departments.jpg){:height="50%" width="50%"}
