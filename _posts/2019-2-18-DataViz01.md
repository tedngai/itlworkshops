...
![test image size](../../../assets/images/pic_jupyter_load_data.jpg){:height="50%" width="50%"}
...
![test image size](../../../assets/images/pic_jupyter_soup.jpg){:height="50%" width="50%"}

<p>If you're not familiar with HTML, it's basically a big mix of human readable language mixed with machine language, and most of the machine language is contained within this <> bracket call <b>Tags</b>. There're lots of common tags, and the one that we see here is <b>TR</b> and <b>TD</b>. <b>TR</b> represents <b>Table / Row</b>, and <b>TD</b> represents <b>Table / Data cell</b>. Each row of data begins with the tag <b>TR</b> and end with this tag <b>/TR</b>. And as we can see here, </p>
